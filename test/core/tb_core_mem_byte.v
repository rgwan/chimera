...
module tb_core_mem_byte;
  ...
  initial begin
    ...
    mem[4] =8'h79; mem[5] =8'h02; mem[6] =8'h01; mem[7] =8'h01; // mov.w #0x0101,R2
    mem[8] =8'h07; mem[9] =8'h23;                              // ldc #0x23,ccr
    mem[10]=8'h68; mem[11]=8'h10;                              // mov.b @R1,R0H
    mem[12]=8'h68; mem[13]=8'h28;                              // mov.b @R2,R0L
    mem[14]=8'h68; mem[15]=8'hA0;                              // mov.b R0H,@R2
    mem[16]=8'h68; mem[17]=8'h98;                              // mov.b R0L,@R1
    mem[16'h0100] = 8'h12;
    mem[16'h0101] = 8'h34;
